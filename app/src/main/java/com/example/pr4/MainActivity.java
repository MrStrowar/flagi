...
public class MainActivity extends ListActivity {
    ...
    String[] things = { "Аргентина", "Бразилия", "Чили", "Колумбия", "Уругвай", "Андрей"};
    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:
                        Intent intent2 = new Intent(MainActivity.this, Braziliya.class);
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Intent intent4 = new Intent(MainActivity.this, Kolubia.class);
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        Intent intent6 = new Intent(MainActivity.this, Yakutia.class);
